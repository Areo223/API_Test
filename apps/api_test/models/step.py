...
from apps.base_model import BaseStep, HeadersFiled, ParamsFiled,\
    ExtractsFiled, ValidatesFiled, BodyTypeFiled, FormDataFiled, JsonDataFiled, FormUrlencodedFiled


class ApiStep(
    BaseStep, HeadersFiled, ParamsFiled, FormDataFiled, FormUrlencodedFiled, JsonDataFiled, ExtractsFiled,
